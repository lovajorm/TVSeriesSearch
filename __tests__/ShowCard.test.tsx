...
import ShowCard from "../src/components/Search/ShowCard"
import "@testing-library/jest-dom"

describe("ShowCard component", () => {
  test("displays the correct show information", () => {
    const mockShow = {
      id: 82,
    ...
    expect(screen.getByText("Drama | Adventure | Fantasy")).toBeInTheDocument()
